...
def main():
    ...
    print("\n[4/6] libs/hbb_common/src/config.rs")
    ...
    print(f"\n{'='*50}")
    print(f"🎉 Done! Applied patches to {total}/6 files.")
    if total < 6:
